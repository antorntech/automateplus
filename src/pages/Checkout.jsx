          ...
          <div className="bg-white p-3 md:p-8 rounded-lg shadow">
            ...
            <div className="space-y-2">
              ...
              <div className="w-full">
                ...
                <button
                  type="submit"
                  className="w-full px-5 py-2 bg-gradient-to-l from-[#FBBB04] to-[#daa003] text-white rounded-md shadow-lg"
                >
                  Pay Now
                </button>
              </div>
